import { CancelTimer } from './useTimeout';
export declare type UseTimeoutDefault = (callback: () => void, timeout: number, deps?: unknown[]) => CancelTimer;
/**
 ...
 */
export declare const useTimeoutDefault: UseTimeoutDefault;
